...
namespace MyWebApi.Application.Validators
{
    public class ApplicationFormEdit_ReqValidator : AbstractValidator<ApplicationFormEdit_Req>
    {
        public ApplicationFormEdit_ReqValidator()
        {
            RuleFor(x => x.ApplicationNo)
                .NotEmpty().WithMessage(string.Format(ErrorMessages.NotEmpty, "申請單號"));
    ...
    public class ItemValidator : AbstractValidator<ApplicationFormEdit_Req.Item>
    {
        public ItemValidator()
        {
            ...
            RuleFor(x => x.Price)
                ...
                .GreaterThan(0).WithMessage(string.Format(ErrorMessages.NumberMustGreater, "價格", "0"));
        }
    }
}
